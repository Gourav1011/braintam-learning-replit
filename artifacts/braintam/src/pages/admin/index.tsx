  ...
  async function updateLiveClassFull() {
    ...
    const r = await apiFetch(`/admin/live-classes/${editingLcFull.id}`, {
      ...
      body: JSON.stringify({
        ...
        scheduledAt: new Date(editingLcFull.scheduledAt).toISOString(),
                      ...
                      <button
                        onClick={() => {
                          setEditingLcFull({
                            ...
                            scheduledAt: (() => { const d = new Date(lc.scheduledAt); const p = (n: number) => String(n).padStart(2,"0"); return `${d.getFullYear()}-${p(d.getMonth()+1)}-${p(d.getDate())}T${p(d.getHours())}:${p(d.getMinutes())}`; })(),
