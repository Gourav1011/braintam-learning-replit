...
export default function OnboardingPage() {
  ...
  // If user has already filled profile (e.g. refreshed page), skip
  useEffect(() => {
    async function checkExistingProfile() {
      try {
        const res = await fetch(`${BASE}/api/student/profile`, { credentials: "include" });
        if (res.ok) {
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 lg:p-12 bg-gray-50 min-h-screen lg:min-h-0">
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-gray-500 text-sm mt-1">Pick your grade and board so we can personalise your feed</p>
          </div>
