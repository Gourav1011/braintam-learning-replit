...
const team = [
  ...
  { name: "Arnav Singh",         role: "Center Coordinator",    bio: "AI and content specialist who helps every Braintam class run smoothly and keeps learning resources organized.", photo: pranjalPhoto, tags: ["AI/ML","Content"] },
...
export default function LandingPage() {
  ...
  return (
    <div style={{ background: BG, color: TEXT, fontFamily: "'Poppins', sans-serif" }} className="min-h-screen overflow-x-hidden">
      ...
      {/* ── ACADEMIC EXCELLENCE ── */}
      <section className="py-4 md:py-8 px-6" style={{ borderTop: `1px solid ${BORDER}` }}>
        <div className="max-w-5xl mx-auto">
          <motion.div variants={fadeUp} initial="hidden" whileInView="show" viewport={{ once: true }} className="text-center mb-3 space-y-1">
            ...
            <p className="text-sm max-w-lg mx-auto" style={{ color: MUTED }}>
              A complete academic ecosystem built around structured growth.
            </p>
          </motion.div>
          {/* Bubble cloud */}
