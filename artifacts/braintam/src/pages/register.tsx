...
export default function RegisterPage() {
  ...
  return (
    <StudentAuthShell
      ...
      title="Start your"
      highlightedTitle="learning journey!"
      description="Create one account for live classes, practice, progress tracking, and rewards across Grades 1–10."
    >
      <div className="mb-7">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <select
            ...
            required
            className="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm bg-[#F8FAFC] focus:outline-none focus:ring-2"
            style={{ color: grade ? NAVY : "#6B7280" }}
          >
        ...
        <button
          ...
          style={{ background: `linear-gradient(135deg, ${ORANGE}, #D95300)` }}
        >
